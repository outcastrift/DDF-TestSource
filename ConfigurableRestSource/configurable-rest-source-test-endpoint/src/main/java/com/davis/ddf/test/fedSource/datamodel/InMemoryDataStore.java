package com.davis.ddf.test.fedSource.datamodel;
 ...
 * Created by Samuel Davis on 7/29/16.
 */
public class InMemoryDataStore {
  ...
  private void populateArrays() {
    ...
    originateUnit.add("Office of the Assistant Secretary of the Army for Acquisitions, Logistics, and Technology " +
            "(ASA" + "(ALT))");
