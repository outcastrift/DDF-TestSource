...
public class TrustingOkHttpClient {
  ...
  private static final Logger logger = LoggerFactory.getLogger(TrustingOkHttpClient.class.getName());
  ...
  public  OkHttpClient getUnsafeOkHttpClient(int readTimeout,
    ...
    try {
      ...
      if(clientCertPath == null || certPassword ==null){
        ...
        logger.info("Client cert path or password were null creating keystore from jar resources  {}",clientCertPath);
